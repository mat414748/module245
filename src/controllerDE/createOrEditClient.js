function createOrEditClient(operationType = 0, tableData) {
    ...
    name.innerText = "Name";
    surname.innerText = "Familienname";
    sex.innerText = "Geschlecht";
    email.innerText = "E-Mail";
    creditRaiting.innerText = "Bonität";
    street.innerText = "Strasse";
    postcode.innerText = "PLZ";
    city.innerText = "Staat";
    billingAdress.innerText = "Rechnungsadresse";
    privatePhonenumber.innerText = "Private Telefonnummer";
    companyPhonenumber.innerText = "Telefonnummer des Unternehmens";
    ...
    nameInput.placeholder = "Kundenname eingeben";
    surnameInput.placeholder = "Kundenfamilienname eingeben";
    sexInput.placeholder = "Kundengeschlecht eingeben";
    emailInput.placeholder = "Kunden E-Mail eingeben";
    creditRaitingInput.placeholder = "Kundenbonität eingeben";
    streetInput.placeholder = "Kundenstaat eingeben";
    postcodeInput.placeholder = "Kunden PLZ eingeben";
    cityInput.placeholder = "Kundenstaat eingeben";
    billingAdressInput.placeholder = "Kundenrechnungsadresse eingeben";
    privatePhonenumberInput.placeholder = "Private Kundennummer eingeben";
    companyPhonenumberInput.placeholder = "Firmen Telefonnummer";
